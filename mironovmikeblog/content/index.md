...
* ***с 03.2021 по сегодняшний день ООО «Информационные Технологии и Коммуникации».*** Глубокая кастомизация Битрикс24 любой сложности с сохранением поддержки обновлений. Интеграция с внешними системами, настройка портала.
  Разработка крупных модулей (включая архитектуру и организацию хранения информации в БД) для enterprise-компаний. Основным проектом является портал Битрикс 24 международной компании, крупнейшего производителя и поставщика светового оборудования в России и ЕАЭС. Список некоторых реализованных крупных модулей системы:
